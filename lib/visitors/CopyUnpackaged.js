...
var CopyUnpackaged = function (cfg) {
    ...
    this.renameFunction = cfg.renameFunction || identity;
};
...
CopyUnpackaged.prototype._processFile = function (sourceFile) {
    ...
    var renameFunction = this.renameFunction;
    var outputFile = packaging.addOutputFile(renameFunction(sourceFile.logicalPath), true);
