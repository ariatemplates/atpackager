...
var ATMultipart = function (cfg) {
     ...
     * @type String
     */
    this.outputEncoding = cfg.outputEncoding; // used by the parent class (Concat).

    /**
     * Specifies the header to put at the beginning of the output file. If specified, it must end with a new line
     * character.
     * @type String
     */
