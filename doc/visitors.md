...
* [Compile Aria Templates beans](#compile-aria-templates-beans-atcompilebeans-)
...
Other configuration properties (such as `onlyFastNorm`) can be used and are documented in the `config` parameter of `aria.utils.BeanExtractor.extract` in the [API of Aria Templates](http://ariatemplates.com/aria/guide/apps/apidocs/#aria.utils.BeanExtractor:extract:method).
